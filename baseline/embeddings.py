...
class EmbeddingBuilder:
    ...
    def save_keypoints_and_y(self):
        np.save(f"{str(self.dataset)}/baseline_model{self.model_n}_keypoints.npy", self.keypoints)
        np.save(f"{str(self.dataset)}/baseline_model{self.model_n}_labels.npy", self.y)

        print(f"keypoints saved in '{str(self.dataset)}/baseline_model{self.model_n}_keypoints.npy' and labels saved in '{str(self.dataset)}/baseline_model{self.model_n}_labels.npy")

    def load_keypoints_and_y(self):
        self.keypoints = np.load(f"{str(self.dataset)}/baseline_model{self.model_n}_keypoints.npy", allow_pickle=True).tolist()
        self.y = np.load(f"{str(self.dataset)}/baseline_model{self.model_n}_labels.npy", allow_pickle=True).tolist()
